...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['sec'])) {
            ...
            if ($id) {
                // Ürün bilgilerini almak için SQL sorgusu hazırla ve çalıştır
                $stmt = $baglanti->prepare("SELECT * FROM addcontent WHERE id = :id");
                    ...
                    <div class="custom-product-item">
                        <form method="post" id="myForm" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="ad" placeholder="Ürün adını girin" value="<?php echo $urun['ad']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="acikla">Ürün Açıklaması</label>
                                <input type="text" name="acikla" placeholder="Ürün açıklaması girin" value="<?php echo $urun['aciklama']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="fiyat">Ürün Fiyatı</label>
                                <input type="text" name="fiyat" placeholder="Ürün fiyatı girin" value="<?php echo $urun['fiyat']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="resim">Ürün Resim Yolu</label>
                                <?php if (empty($_FILES['resim']['name'])) : ?>
                                    <img width="50px" src="../img/<?php echo $urun['img']; ?>" alt="<?php echo $urun['ad']; ?>">
                                <?php else : ?>
                                    <img width="50px" src="../img/home/<?php echo $_FILES['resim']['name']; ?>" alt="<?php echo $_FILES['resim']['name']; ?>">
                                <?php endif; ?>
                                <br><br>
