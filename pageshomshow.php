...
.product-img {
        ...
        #messageDetail {
            max-height: 400px;
           /* Mesaj içeriğinin maksimum yüksekliği */
            overflow-y: auto; /* Dikey taşma durumunda scroll çubuğunu göster */
        }
    </style>
</head>
                    ...
                    <tbody>
                        <?php foreach ($sonuclar as $sonuc) : ?>
                            <tr>
                                ...
                                <td><?php echo $sonuc['fiyat'] ?> TL</td>
                                <td> <img src="../img/<?php echo $sonuc['img'] ?>" alt="<?php echo $sonuc['ad'] ?>" width="100px" height="100px"></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
